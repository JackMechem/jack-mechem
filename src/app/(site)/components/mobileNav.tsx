...
const MobileNav = () => {
    ...
    return (
        <div className="md:hidden fixed w-full bg-primary/70 backdrop-blur-md drop-shadow-secondary border-border/50 rounded-t-[30px] py-[8px] px-[15px] bottom-0 flex flex-row justify-evenly right-0 z-50">
            {pathname === "/" ? (
